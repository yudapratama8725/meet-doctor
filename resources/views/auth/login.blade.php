    ...
    <div class="grid lg:grid-cols-2">
      ...
      <div class="px-4 lg:px-[91px] pt-10">
        ...
        >
          <img
            class="h-12 lg:h-16"
            src="{{ asset('asset/frontsite/images/logo.png') }}"
        ...
        >
          ...
          <div class="mt-12">
            ...
            <form method="POST" action="{{ route('login') }}" class="grid gap-6">
              ...
              <label class="block">
                <input
                  for="password" type="password" name="password" id="password"
                  class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                  placeholder="Password":value="{{ __('Password') }}" required autocomplete="current-password"
                />
        ...
        <div class="flex flex-col justify-center h-full px-24 pt-10 pb-20">
          <div class="relative">
            <div class="relative top-0 -left-5 mb-7">
              <img
                src="{{ asset('asset/frontsite/images/blockqoutation.svg') }}"
                class="h-[30px]"
                alt=""
              />
            </div>
              ...
              <div class="flex items-center">
                <div class="ring-1 ring-[#0D63F3] ring-offset-4 rounded-full">
                  <img
                    ...
                    src="{{ asset('asset/frontsite/images/patient-testimonial.png') }}"
                    alt=""
                  />
                </div>
                <div class="ml-5">
